...
var purchase = function(){
	inquirer.prompt([
	{
 	...
 	},
 	{
 		...
 		connection.query('SELECT * FROM products INNER JOIN departments ON (products.department_name=departments.department_name)'+
 						' WHERE (products.product_name = ?)', user.product, function(err,res){
 			if (err) throw err;
 			//check stock
 			//
